...
class particleFilter(Node):
    ...
    def initializeParticleFilter(self, x, y, th):
        ...
        poses_x = np.random.normal(x, self.std_particle_x, numParticles)
        poses_y = np.random.normal(y, self.std_particle_y, numParticles)
        poses_th = np.random.normal(th, self.std_particle_theta, numParticles)
        self.particlePoses = np.vstack((poses_x, poses_y, poses_th)).T
